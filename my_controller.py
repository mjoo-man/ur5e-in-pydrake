...
class FeedbackController(LeafSystem):
    ...
    def CalcControlEffort(self, simulator_context, output):
        ...
        # a bad controller with oscillating torques and gravity compensation
        tau_control = np.ones_like(Vq)*np.sin(simulator_time)*0.01 - Vq  # get the manipulator the torques to hold steady over gravity
